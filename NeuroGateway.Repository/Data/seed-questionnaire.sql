...
INSERT INTO questionnaire_item (sort_order, scenario, label, option_text, primary_chemical, secondary_chemical) VALUES
...
ON CONFLICT (sort_order, label) DO UPDATE SET
    ...
    primary_chemical = EXCLUDED.primary_chemical, secondary_chemical = EXCLUDED.secondary_chemical;
...
INSERT INTO questionnaire_item (sort_order, scenario, label, option_text, primary_chemical, secondary_chemical, is_inverted) VALUES
